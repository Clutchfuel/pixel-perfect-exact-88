...
const variants: Record<Variant, string> = {
  primary:
    "bg-lime text-primary-foreground hover:bg-lime-dark hover:-translate-y-0.5 shadow-[0_8px_30px_-8px_rgba(198,255,77,0.35)] hover:shadow-[0_12px_40px_-8px_rgba(198,255,77,0.45)]",
