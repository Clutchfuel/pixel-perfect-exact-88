...
import athleteSweat from "@/assets/athlete-sweat.jpg";
              ...
              return (
                <Reveal key={r.title} delay={0.1 + i * 0.08}>
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="font-display text-xl font-extrabold tracking-display text-white">
                        {r.title}
                      </h3>
                      <p className="mt-1 max-w-md text-base text-muted-dark">
                        {r.copy}
                      </p>
                    </div>
                  </div>
          ...
          <Reveal delay={0.3}>
            <div className="mt-12 max-w-xl rounded-3xl glass-dark p-7 lime-glow">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs uppercase tracking-eyebrow text-lime">
                  Free
                </span>
              </div>
