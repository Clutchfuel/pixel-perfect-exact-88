...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The two easiest levers are light and temperature. Bright light in the morning, dim light after sunset, and a cool bedroom (65–68°F) do more for sleep quality than any supplement.",
  ...
  },
  {
    ...
    body: [
      ...
      "For anything longer or more intense, aim for a real meal 2–3 hours ahead: carbs for fuel, a moderate amount of protein, and low to moderate fat. Think oatmeal with berries and a scoop of yogurt, or rice with chicken and vegetables.",
      "Timing is the underrated variable. Eating too close to a hard session sends blood to your gut when you need it in your muscles. Eating too far ahead leaves you running on empty. The 2–3 hour window is the sweet spot for a meal; 30–60 minutes is the window for a small snack.",
    ...
    takeaways: [
      ...
      "Longer or harder sessions: real meal 2–3 hours before.",
      "Small snack in the 30–60 min window if the meal was too far back.",
      "Caffeine peaks 60–90 minutes after intake — plan accordingly.",
    ],
  },
  {
    ...
    body: [
      ...
      "For hydration, aim for roughly 16–24 oz of fluid per pound lost during the session, ideally with sodium in the mix. Plain water alone leaves the recovery incomplete.",
    ...
    takeaways: [
      ...
      "Replace 16–24 oz of fluid per pound lost, ideally with sodium.",
  ...
  },
  {
    ...
    body: [
      ...
      "The mistake isn't doing both. It's treating both like they need to be maximum effort. Pick a priority, keep the other supportive, and adjust every 8–12 weeks.",
    ],
    takeaways: [
