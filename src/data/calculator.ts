export const calculatorMessaging = {
  caloriesDisclaimer:
    "Calories help us better understand workout intensity, but your hydration needs are still based on your full performance profile.",
  caloriesLabel: "Calories burned, if available",
  caloriesHint: "Optional — from your watch or fitness app",
  deviceHeadline: "Connect Your Device",
  deviceSub:
    "Sync workout data from your favorite fitness app to make your Clutch Score more personalized.",
  quickEstimateTitle: "Quick Estimate",
  quickEstimateSub: "Under 15 seconds for repeat use — no weight or fluid math required.",
  fullProfileTitle: "Full Profile",
  fullProfileSub: "Five questions for your deepest hydration profile.",
} as const;
...
export type DeviceIntegration = {
  ...
  /** Fields this integration will eventually sync */
  syncFields: string[];
};
...
export const quickEstimateFields = {
  ...
  intensity: {
    ...
    options: [
      { value: "low", label: "Easy / recovery", description: "Conversational pace" },
      { value: "moderate", label: "Moderate", description: "Working but controlled" },
      { value: "high", label: "Hard / redline", description: "Race pace or max effort" },
    ],
  },
  sweatLevel: {
    label: "Sweat level",
