...
<html><body style="font-family:Inter,Arial,sans-serif;color:#0A0A0A;line-height:1.5">
  <p>Your Clutch Score results from <strong>${SITE_NAME}</strong>:</p>
  <p style="font-size:32px;font-weight:800;margin:16px 0">${result.score}</p>
  <p><strong>Sweat Profile:</strong> ${result.profile}</p>
  ...
  <p style="color:#71717A;font-size:12px;margin-top:32px">Saved for ${email}. Not medical advice.</p>
</body></html>`;
}
