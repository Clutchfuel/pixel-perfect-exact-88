      ...
      <article>
        <header className="border-b border-white/5">
          <div className="mx-auto w-full max-w-3xl px-5 pt-14 pb-10 sm:px-8 sm:pt-24">
            <Link to="/performance-hub" className="inline-flex items-center gap-2 text-xs uppercase tracking-eyebrow text-white/50 hover:text-electric">
            ...
            <p className="mt-4 text-xs uppercase tracking-eyebrow text-white/45">{article.readingTime}</p>
          </div>
        ...
        <div className="mx-auto w-full max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-2 text-white/70">Find your biggest performance opportunity in 60 seconds.</p>
            <Link
              to="/clutch-score"
            ...
            {related.map((a: typeof related[number]) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-3 text-lg font-semibold leading-snug transition group-hover:text-electric">{a.title}</h3>
                </div>
              </Link>
            ))}
          </div>
