    ...
    handlers: {
      GET: async () => {
        ...
        const entries: SitemapEntry[] = [
          ...
          { path: "/clutch-score", changefreq: "weekly", priority: "0.9", lastmod: today },
          { path: "/sweat-rate", changefreq: "monthly", priority: "0.8", lastmod: today },
          { path: "/platform", changefreq: "monthly", priority: "0.7", lastmod: today },
